  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active"> <a class="nav-link" href="panou_informativ.php">Panou informativ</a> </li>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
		...
		<tbody>
		<?php  while($row = mysqli_fetch_array($afisare_studenti)) { ?>
    <tr>
          ...
          if($row['bol_cazat'])
          {
            echo("<span class='text-success'>Cazat</span>");
          }
          else
          {
            echo("<span class='text-danger'>lista de asteptare/respins</span>");
          }
          ?></td>
    </tr>		
		<?php } ?>
