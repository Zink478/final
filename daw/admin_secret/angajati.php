  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item"> <a class="nav-link" href="index.html">Acasă</a> </li>
        ...
        <li class="nav-item active"> <a class="nav-link" href="angajati.php">Angajati</a> </li>
...
<section class="slider_section">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12">
        <div>
          <h1>Aici se vor introduce portarii caminului <br></h1>
          <p><em>(Răspunzătorii de etaje)</em></p>
		...
		<tr>
          ...
          <td>
              <a class="btn btn-info" href="angajati.php?edit_angajat=<?php echo $row['ID_personal']; ?>">Editeaza</a>
            </td>

            <td>
              <a class="btn btn-danger"  href="angajati.php?del_angajat=<?php echo $row['ID_personal']; ?> ">Sterge</a>
            </td>
        </tr>			
		<?php } ?>
    </tbody>
            ...
            <input type="hidden" name="ID_personal" value="<?php  echo $id;  ?>">
              Nume angajat <input type="text" name="nume_personal" value="<?php  echo $nume_personal;  ?>"><br>
              Prenume angajat <input type="text" name="prenume_personal" value="<?php  echo $prenume_personal;  ?>"><br>
              Contact angajat <input type="text" name="contact_personal" value="<?php  echo $contact_personal;  ?>"><br>

              <div>
                <?php if($edit_state == false): ?>                   
                <button type="submit" name="save_angajat" class="btn btn-success">Adauga</button>
                    
                <?php else: ?>           
                <button type="submit" name="update_angajat" class="btn btn-danger">Modificare</button>
                <?php endif ?>	
            </div>
            <br>
            </form>
